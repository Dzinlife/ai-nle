...
(function (CanvasKit) {
	...
	CanvasKit._extraInitializations.push(function () {
		...
		CanvasKit.MakeGPUCanvasSurface = function (
			canvasCtx,
			colorSpace,
			width,
			height,
			...
			let surface = this.MakeGPUTextureSurface(
		...
		CanvasKit.MakeGPUTextureSurface = function (
			devCtx,
			texture,
			textureFormat,
			width,
		...
		CanvasKit.Surface.prototype.assignCurrentSwapChainTexture = function () {
			...
			return this._replaceBackendTexture(
				...
				CanvasKit.WebGPU.TextureFormat.indexOf(
					this._canvasContext._textureFormat,
				),
				ctx.canvas.width,
				ctx.canvas.height,
			);
